...
<body>
    ...
    <section>
        ...
        <div id="board_box">
            ...
            <form name="board_form" method="post" action="board_photo_action.php" enctype="multipart/form-data">
                <ul id="board_form">
                    <li>
                ...
                <ul class="buttons">
                    ...
                    <li><button type="button" onclick="location.href='board_photo_list.php'">취소</button></li>
                </ul>
            </form>
        </div> <!-- board_box -->
    </section>
